        ...
        <form role="form" method="post" action="<?=site_url('User_con/insertuser')?>">                    
            <div class="modal-body">                   
                ...
                <div class="form-group row row-offcanvas">
                    ...
                    <div class="col-sm-9">
                        <select name="position" class="btn btn-default dropdown-toggle" style="width: 100%; important"data-toggle="dropdown" aria-expanded="true" required>                             
        ...
        <form role="form" method="post" action="<?=site_url('User_con/updateuser')?>">                    
            <div class="modal-body">    
                ...
                <div class="form-group row row-offcanvas">
                    <label class="col-sm-3 control-label">Position</label>
                    <div class="col-sm-9">
                        <select id="position" name="position" class="btn btn-default dropdown-toggle" style="width: 100%; important" data-toggle="dropdown" aria-expanded="true" required>                             
                            <option value="Admin"> Admin</option>   
                            <option value="Supervisor"> Supervisor</option>                                 
                            <option value="Cashier"> Cashier</option>                    
                        </select>  

    ...
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            <h3 class="panel-title pull-left" style="padding-top: 8px;font-size: 20px;">
                <span class="glyphicon glyphicon-user" ></span> Customer Category
            </h3>        
        <div class="panel-toolbar text-right">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-info " >New</button>              
            <a href="<?php echo site_url('Customer_con') ?>" type="button" class="btn btn-success" style="padding-right: 5px;" >Customer</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr> 
                        <td class="text-center">
                           ...
                           <button title="Edit" 
                                data-cno="<?php echo $item->cc_no;?>"
                                data-name="<?php echo $item->name;?>"
                                data-toggle="modal" data-target="#cat-edit" 
                                class="glyphicon glyphicon-pencil btn btn-info cat-edit"></button>
                        
                           <a type="button" title="Delete" href="<?=site_url('Customercategory_con/delcategory/'.$item->cc_no)?>" onclick="return confirm('Do you want to delete this Category?');" class="glyphicon glyphicon-trash btn btn-danger"></a>                           
                                                   
                        </td>
                        <td class="text-center" style="text-transform: capitalize"><?php echo $item->cc_no ?></td>                        
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg"> 
    ...
    <div class="modal-content">
        ...
        <form role="form" method="post" action="<?=site_url('Customercategory_con/insertcategory')?>">                    
            ...
            <div class="modal-footer">
                <a title="Close" href="<?=site_url('Customercategory_con')?>" onclick="return confirm('Do you want to cancel');" type="button" class="btn btn-danger glyphicon glyphicon-floppy-remove" ></a>
...
<div id="cat-edit" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg"> 
    ...
    <div class="modal-content">
        ...
        <form role="form" method="post" action="<?=site_url('Customercategory_con/updatecategory')?>">                    
            <div class="modal-body">  

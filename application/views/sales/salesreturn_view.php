    ...
    <div class="panel panel-default">
        <div class="panel-heading ">
            <h3 class="panel-title pull-left" style="padding-top: 8px;font-size: 20px;">
                <span class="glyphicon glyphicon-shopping-cart" ></span> Point Of Sales - <span class="text-danger"><strong>RETURN</strong></span>
            </h3>            
                ...
                <tbody>
                    ...
                    <tr class="danger">    
                        ...
                        <td class="text-center" style="text-transform: capitalize">
                            ...
                            <a title="Edit" href="<?=site_url('Salesreturn_con/deletetransactionline/'.$item->tl_no)?>" class="glyphicon glyphicon-trash btn btn-sm btn-danger" onclick="return confirm('Do you want to delete this product');"></a>
                        </td>
                    </tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">                        
                                <a title="Edit" href="<?=site_url('Salesreturn_con/deletecustomer/'.$customer[0]->c_no)?>" class="glyphicon glyphicon-minus btn btn-danger btn-sm" onclick="return confirm('Do you want to Remove this Customer');"></a>
                            </div>
                        </div>
                        <?php } ?>     
  ...
  <div class="modal-dialog modal-sm"> 
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">      
            ...
            <hr>
            <form onsubmit="return editproductpriceform(this);" role="form" method="post" action="<?=site_url('Salesreturn_con/updatetransactionlineprice')?>">    
            <input id="tlno" class="form-control input-sm hide" type="text" name="tlno" />

...
<div class="col-md-10 main" >
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            <h3 class="panel-title pull-left" style="padding-top: 8px;font-size: 20px;">Customer Credit Payment Report</h3>                          
        ...
        <div class="panel-body">    
            <form role="form" method="post" action="<?=site_url('creditpayment_con/search')?>">                  
                <div class="form-group row row-offcanvas" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-3">
                        <select name="c_no" class="btn btn-default dropdown-toggle col-sm-12 " data-toggle="dropdown" aria-expanded="true" required>                                                                                        
                            ...
                            <?php for($c=0;$c<count($cus);$c++) {?>
                            <option value="<?php echo $cus[$c]->c_no;?>" ><?php echo $cus[$c]->name;?></option>
                            <?php } ?>
                        </select>  
                    </div>
            ...
            <hr>
                <table class="table table-bordered table-condensed" >                                  
                    <tr>
                        <td class="text-center" style="vertical-align: middle;" ><strong>Total Cash</strong></td>
                        <td class="text-center" style="vertical-align: middle;" ><strong><?php echo number_format((float)$sumcash[0]->amount,2,'.',',');?></strong></td>
                        <td class="text-center" style="vertical-align: middle;" ><strong>Total Check</strong></td>
                        <td class="text-center" style="vertical-align: middle;" ><strong><?php echo number_format((float)$sumcheck[0]->amount,2,'.',',');?></strong></td>
                    </tr>
                    <tr>
                        <td colspan="4" class="text-center" style="vertical-align: middle;" ><strong>Grand Total:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo number_format((float)($sumcash[0]->amount+$sumcheck[0]->amount),2,'.',',');?></strong></td>
                    </tr>
                </table>
            ...
            <table class="table table-hover table-responsive table-bordered table-striped info" id="MTable">                                                
                <thead>
                    <tr >
                        <td class="text-center" style="vertical-align: middle;" ><strong>Name</strong></td>
                        <td class="text-center" style="vertical-align: middle;" ><strong>Ref. No.</strong></td>
                        <td class="text-center" style="vertical-align: middle;" ><strong>Date</strong></td> 
                        <td class="text-center" style="vertical-align: middle;" ><strong>Description</strong></td>
                ...
                <tbody>
                    ...
                    <tr>                         
                        <td class="text-center" style="text-transform: capitalize;"><?php echo $pay[$p]->name;?></td>
                        <td class="text-center" style="text-transform: capitalize;"><?php echo $pay[$p]->ref_no;?></td>
                        <td class="text-center" style="text-transform: capitalize;"><?php echo $pay[$p]->date;?></td>
                        <td class="text-center" style="text-transform: capitalize;"><?php echo $pay[$p]->description;?></td>
                        <td class="text-center"><?php echo number_format((float)$pay[$p]->amount,2,'.',',');?></td>                                  
                    </tr>
                    <?php }?>                   
                </tbody>                               
            </table>     
...
<div id="printreport" class="modal fade " role="dialog" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 1050;">
   ...
   <!--             Modal content-->
    <div class="modal-content">
        ...
        <form role="form" method="post" action="<?=site_url('creditpayment_con/printreport')?>">
...
<div id="excelprintreport" class="modal fade " role="dialog" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="z-index: 1050;">
   ...
   <!--             Modal content-->
    <div class="modal-content">
        ...
        <form role="form" method="post" action="<?=site_url('creditpayment_con/excelprintreport')?>">
            <div class="modal-body">                                                             
                <div class="form-group row row-offcanvas" style="margin-top: 10px;">
                    <label class="col-sm-12 control-label">Customer</label>
                    <div class="col-sm-12">

...
<div class="col-md-10 main pl0" >
    ...
    <div class="panel-heading" style="padding: 6px 12px;">
        ...
        <span class="glyphicon glyphicon-grain"></span> Poultry Production
    	</div>
    	<div class="panel-toolbar text-right">
    		<a href="<?php echo site_url('print_con/production_print') ?>" class="btn btn-primary btn-sm">
    			<span class="glyphicon glyphicon-print"></span> Print
    		</a>
    		<a href="<?php echo site_url('excel_con/production_excel') ?>" class="btn btn-success btn-sm">
    ...
    <div class="panel-body">
	    <div class="row">
	    	<form action="<?php  echo site_url('reports_con/production/summary'); ?>" method="get" accept-charset="utf-8" class="col-xs-8 col-xs-offset-2 form-inline pr0 mb15">
		    	<div class="row">
		    		<div class="col-xs-12">
	    		...
	    		<table class="table table-bordered table-condensed" id="datatable">
	    			<thead>
	    				<tr>
	    					...
	    					<td>Quantity</td>
	    					<td>Received by</td>
	    					<td>Poultry Product</td>
	    				</tr>
	    			</thead>
		    		<tbody>
	    				<?php foreach ($result as $key => $p): ?>
	    					<tr>
	    						<td><?php echo $p->building_no . ($p->buildingname && $p->building_no ? ' - ' : '') . $p->buildingname ?></td>
	    						<td><?php echo $p->date ?></td>
	    						<td><?php echo $p->time ?></td>
	    						<td><?php echo $p->totalqty ?></td>
	    						<td><?php echo $p->receivedby ?></td>

...
<div class="col-md-10 main pl0" >
    ...
    <div class="panel-heading" style="padding: 6px 12px;">
    	...
    	<div class="panel-toolbar text-right">
    		<a href="<?php echo site_url('print_con/consumption_print') ?>" class="btn btn-primary btn-sm">
    			<span class="glyphicon glyphicon-print"></span> Print
    		</a>
    		<a href="<?php echo site_url('excel_con/consumption_excel') ?>" class="btn btn-success btn-sm">
    ...
    <div class="panel-body">
	    <div class="row">
	    	<form action="<?php  echo site_url('reports_con/consumption/summary'); ?>" method="get" accept-charset="utf-8" class="col-xs-8 col-xs-offset-2 form-inline pr0 mb15">
		    	<div class="row">
		    		<div class="col-xs-12">

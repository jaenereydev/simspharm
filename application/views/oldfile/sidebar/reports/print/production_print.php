...
<div class="container-fluid main pt15" style="background: #fff; margin-top: 50px">
	<div class="form-group hiddenPrint">
		<a href="<?php echo site_url('reports_con/production/summary') ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-chevron-left"></span> Back to Production Reports</a>
		...
		if($key % 36 == 0) :?>
			<div class="<?php if($key != 0) echo 'page' ?>">
				<table class="table table-bordered table-condensed text-center mb5">
					<tr>
						<td class="semibold">PRODUCTIONS</td>
					</tr>
				</table>
	...
	<?php endif?> 
					<tr>
						<td><?php echo $value->building_no . ($value->buildingname && $value->building_no ? ' - ' : '') . $value->buildingname ?></td>

...
header("Content-Disposition: attachment; filename=Dailyinventoy". $d .".xls");
...
<table style="margin: 0 auto;">
        <tr>
            <td colspan="14" style="text-align: center; padding-left: 40px;padding-right: 40px; font-size: 10px;">             
    ...
    <div>
        <table style="width: 100%;margin: 0 auto;" width="500px">               
            <tr>
                <td colspan="13"><strong>Category: </strong> <strong><?php if($cno == 'all'){ echo "ALL";                        
                                        }else { 

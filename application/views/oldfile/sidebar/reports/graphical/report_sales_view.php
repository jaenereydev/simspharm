...
<div class="col-md-10 main pl0" >
    ...
    <div class="panel-body">
	    <div class="row">
	    	<form action="<?php  echo site_url('reports_con/sales/graphical'); ?>" method="get" accept-charset="utf-8" class="col-xs-8 col-xs-offset-2 form-inline pr0 mb15">
		    	<div class="row">
		    		<div class="col-xs-12">
	    	...
	    	<div class="col-xs-10 col-xs-offset-1 pt15">
	    		<table class="table table-bordered text-center odd">
	    			<tr>
	    				...
	    				<td class="pa5"><strong class="fsize24">P <?php if(isset($sum)) echo number_format($sum[2], 2) ?></strong></td>
	    			</tr>
	    		</table>
	    	</div>
	    </div>

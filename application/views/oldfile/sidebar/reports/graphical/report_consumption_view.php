...
<div class="col-md-12 main pl5 pr5" style="margin-top: 55px">
    ...
    <div class="panel-heading" style="padding: 6px 12px;">
        ...
        <span class="glyphicon glyphicon-grain"></span> Consumption per Building Graphical Report
    	</div>
    	<div class="panel-toolbar"></div>
    </div>
    <div class="panel-body">
	    <div class="row">
	    	<form action="<?php  echo site_url('reports_con/consumption/graphical'); ?>" method="get" accept-charset="utf-8" class="col-xs-9 col-xs-offset-2 form-inline pr0 mb15">
		    	<div class="row">
		    		<div class="col-xs-12">
	    	...
	    	<div class="col-xs-4 col-xs-offset-4 pt15">
	    		<table class="table table-bordered text-center odd">
	    			<tr>
	    				...
	    				<td class="pa5"><strong class="fsize24"><?php if(isset($sum)) echo 'P ' . number_format($sum, 2) ?></strong></td>
	    			</tr>
	    		</table>
	    	</div>
	    </div>

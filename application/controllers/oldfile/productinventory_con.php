...
class Productinventory_con extends CI_Controller
{
    //--------------------------------------------------------------------------
    ...
    public function __construct() 
    {
        ...
        $this->load->model('Productinventory_model');
    ...
    {               
        ...
        $this->load->view('sidebar/reports/Productinventory', array('cat' => $cat, 'prodh' => $prodh, 'dsc' => $dsc,'users' => $users, 'prod' => $prod));
    ...
    {       
        ...
        $this->load->view('sidebar/reports/print/productinventory_print', array('cat' => $cat, 'cno' => $cno, 'com' => $com, 'd' => $value, 'prodh' => $prodh, 'dsc' => $dsc,'users' => $users, 'prod' => $prod));
    ...
    {       
        ...
        $users = $this->Heading_model->user_det();   
        $com = $this->Company_model->get_companyinfo();
        $this->load->view('sidebar/reports/export_excel/productinventory_print', array('cat' => $cat, 'cno' => $cno, 'com' => $com, 'd' => $value, 'prodh' => $prodh, 'dsc' => $dsc,'users' => $users, 'prod' => $prod));
